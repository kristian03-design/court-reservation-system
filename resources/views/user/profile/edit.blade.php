...
<head>
    ...
    <title>Profile | CourtConnect</title>
...
<body>
    ...
    <main class="main-shell">
        ...
        <h1 class="text-3xl font-bold text-[#0F2447]">Profile Settings</h1>
        <p class="mt-3 text-[#64748B]">Profile editing hooks are ready for account management expansion.</p>
    </section></div>
        </div>
    </main>
    @stack('scripts')
