...
<body>
    ...
    <main class="main-shell">
        <div class="site-container">
            ...
            @endif
            <div class="content-space"><h1 class="text-3xl font-bold text-[#0F2447]">Reservations</h1>
    <p class="mt-3 text-[#64748B]">Reservation history and filters can be expanded from the dashboard table.</p></div>
        </div>
    </main>
    @stack('scripts')
</body>
