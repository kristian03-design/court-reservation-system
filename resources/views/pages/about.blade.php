...
<body>
    ...
    <main>
        ...
        <p class="text-sm font-semibold text-[#57C271]">About CourtConnect</p>
        <h1 class="mt-3 text-4xl font-bold text-[#0F2447]">A modern operating system for sports court reservations</h1>
        <p class="mt-5 leading-7 text-[#64748B]">CourtConnect helps facilities publish schedules, manage reservations, track payments, and give players a smooth booking experience from phone to front desk.</p>
    </section>
    </main>
