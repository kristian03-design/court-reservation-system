...
<body>
    ...
    <main>
        ...
        <div>
            <p class="text-sm font-semibold text-[#57C271]">Contact</p>
            <h1 class="mt-3 text-4xl font-bold text-[#0F2447]">Talk to the facility team</h1>
            <p class="mt-5 leading-7 text-[#64748B]">Questions about schedules, pricing, payments, or events? Send a note and the operations team can respond from the admin workflow.</p>
        </div>
        <section class="card">
            <form class="grid gap-4">
                <input class="rounded-lg border border-[#E5E7EB] px-4 py-3" placeholder="Full name">
                <input class="rounded-lg border border-[#E5E7EB] px-4 py-3" placeholder="Email">
                <textarea class="min-h-32 rounded-lg border border-[#E5E7EB] px-4 py-3" placeholder="Message"></textarea>
