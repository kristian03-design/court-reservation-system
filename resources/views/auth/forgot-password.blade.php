...
<body>
    ...
    <main>
        ...
        <section class="card">
            <h1 class="text-3xl font-bold text-[#0F2447]">Reset your password</h1>
            <form class="mt-6 grid gap-5" method="POST" action="{{ route('password.email') }}">
                @csrf
                <label class="grid gap-2 text-sm font-semibold">Email
                    <input class="rounded-lg border border-[#E5E7EB] px-4 py-3 font-normal" type="email" name="email" required>
                </label>
